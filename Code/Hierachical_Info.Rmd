...
```{r}
# MTS Sex
sex_mts <- ts(t(sex[1:2, 3:23]))
model_sex_1 = VARMA(sex_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_sex_1, h = 1, orig = 0)

# MTS Sex
sex_mts <- ts(t(sex[3:4, 3:23]))
model_sex_3 = VARMA(sex_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_sex_3, h = 1, orig = 0)

# MTS Sex
sex_mts <- ts(t(sex[29:30, 3:23]))
model_sex_15 = VARMA(sex_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_sex_15, h = 1, orig = 0)
```
# MTS Forecast (Age) -- Cannot Run, Why?
```{r}
# MTS Sex
age_mts <- ts(t(age[1:18, 3:23]))
model_age_1 = VARMA(age_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_age_1, h = 1, orig = 0)

# MTS Sex
age_mts <- ts(t(age[37:54, 3:23]))
model_age_3 = VARMA(age_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_age_3, h = 1, orig = 0)

# MTS Sex
age_mts <- ts(t(age[271:288, 3:23]))
model_age_15 = VARMA(age_mts, p=1, q=1, include.mean=FALSE)
VARMApred(model_age_15, h = 1, orig = 0)
```
