...
def LSTM_FitPredict(sa3_codes, population_dict, n_steps, train_bounds, val_bounds, test_bounds, n_features, epochs_num, sex_label, pred_start, tuner, output, minima_dict, maxima_dict):
